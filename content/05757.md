...
Ethereum improvement proposals (EIPs) occasionally link to resources externaoeual to this repository. This document sets out the requirements for origins that may be linked to, and the process for approving a new origin.
